package com.amayha.dmi.crudfirebase;
...
import com.amayha.dmi.crudfirebase.model.Persona;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void listarDatos() {
        databaseReference.child(tablaPersonas).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d("calupe","Ejecuto setAdapter...!!!");
            }
        ...
        switch (item.getItemId()) {
            case R.id.icon_add:
                if (validacion()) {
                    ...
                    databaseReference.child(tablaPersonas).child(p.getUid()).setValue(p);
